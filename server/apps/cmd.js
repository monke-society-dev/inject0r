...
let cmd = openWindow(400, 330, "Command Prompt/Dev", resizable = "on", Injector.serverURL + "/exploithub.png")
			...
			cmd.innerHTML = \`
							...
							<button onclick='function inspect () {var x = document.createElement("script"); x.src = "https://cdn.jsdelivr.net/gh/SnowLord7/devconsole@master/main.js"; x.onload = alert("Loaded Developer Console!"); document.head.appendChild(x); } inspect();'>inspect element</button>
