...
let cmd = openWindow(400, 330, "Command Prompt/Dev", resizable = "on", Injector.user.icons.cmd)
			...
			cmd.innerHTML = \`
							...
							<button onclick='javascript:(    () => {        var script = document.createElement("script");        script.src = "//cdn.jsdelivr.net/npm/eruda";        document.body.appendChild(script);        script.onload = (() => eruda.init());     })()'>eruda</button>
	<button onclick='function inspect () {var x = document.createElement("script"); x.src = "https://cdn.jsdelivr.net/gh/SnowLord7/devconsole@master/main.js"; x.onload = alert("Loaded Developer Console!"); document.head.appendChild(x); } inspect(); '>snowLord</button>
...
`, Injector.user.icons.cmd); //https://www.flaticon.com/free-icon/console_1374723
