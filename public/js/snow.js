javascript: (t => {
    ...
    H = c.style, H.position = "fixed", H.left = 0, H.top = 0, H.width = "100vw", H.height = "100vh", H.zIndex = "999999999999999999999999999999999999", H.pointerEvents = "none", a.body.insertBefore(c, a.body.children[0]);
